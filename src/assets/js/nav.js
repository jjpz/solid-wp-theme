function checkSiteHeaderWidth() {
	...
	let siteHeaderPaddingRight = parseInt(
		window.getComputedStyle(siteHeader).getPropertyValue('padding-right')
	);
	...
	let buttonNavWidth = siteHeader.querySelector('.button-nav').offsetWidth;
	siteHeaderWidth =
		siteBrandingWidth + mainNavWidth + buttonNavWidth + siteHeaderPadding;
...
function checkStickyNav() {
	...
	let offsetHeight = offsetHeightElem ? offsetHeightElem.offsetHeight : '';
